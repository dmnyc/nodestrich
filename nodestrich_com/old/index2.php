...
A community for node runners using Nostr. Users of all levels are welcome to join, open channels, share knowledge, and build the Nostr circular economy. We run an active Telegram group. <br /><br />To learn more and join, click one of the icons below:</p>
      <!-- <p id="communityDescription"><?php echo htmlspecialchars($communityDescription); ?></p> -->
      <p class="center">
        <span>
